...
UmamusumeLocalify_CCFLAGS = -Wno-error=unused-function  -Wno-error=unused-variable -Wno-error=return-stack-address -std=c++20 -fobjc-arc -Isrc/rapidjson/include
